...
export default function EditBlogPage() {
  ...
  if (isFetching) {
    return <div className="p-8 text-center text-slate-500">Loading post...</div>;
  }
    ...
    <div className="space-y-6 max-w-4xl mx-auto pb-12">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-slate-600 dark:text-slate-400 mt-1">Update your SEO-optimized article.</p>
        </div>
      </div>
