      ...
      <div className="relative z-20 mx-auto max-w-4xl px-6 pb-24 lg:px-8 -mt-8 lg:-mt-16">
        <div className="rounded-3xl bg-white dark:bg-[#111827] px-6 py-10 shadow-xl shadow-slate-200/50 dark:shadow-none ring-1 ring-slate-100 dark:ring-slate-800 sm:px-12 sm:py-16">
          ...
          <div className="prose prose-slate dark:prose-invert prose-blue max-w-none prose-headings:font-extrabold prose-headings:tracking-tight prose-a:font-semibold prose-a:text-blue-600 dark:prose-a:text-blue-400 hover:prose-a:text-blue-500 leading-relaxed">
            ...
            <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 dark:text-white mt-2 mb-6">Abstract & API Services Data Policy</h2>
            <p>
            ...
            <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 dark:text-white mt-12 mb-6">Interpretation and Definitions</h2>
            <p>
            ...
            <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 dark:text-white mt-12 mb-6">Collecting and Using Your Personal Data</h2>
            <p>
            ...
            <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 dark:text-white mt-12 mb-6">Requesting Account & Data Deletion</h2>
            <p>
            ...
            <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 dark:text-white mt-12 mb-6">Tracking Technologies and Cookies</h2>
            <p>
