...
const tiers = [
  {
    ...
    description: 'Explore the platform with basic features before committing. (14 Days)',
    features: [
      '3 InstantSites per day',
      '5 SEO Audits per day',
      '3 AI Detection Scans per day',
      '1,000 AI Content words total',
  ...
  },
  {
    ...
    features: [
      '5 InstantSites per month',
      '10 SEO Audits per month',
      '5,000 AI Content words per month',
      'Unlocked: AI Detector (Unlimited)',
      'Unlocked: AI Tutor & Grammar Checker',
      'NO Image, Video, or Humanizer',
    ],
    icon: Zap,
  },
  {
    ...
    features: [
      '15 InstantSites per month',
      '50 SEO Audits per month',
      '10,000 AI Content words per month',
      '15 AI Image generations per month',
      '1 AI Video generation per month',
      'Unlocked: AI Humanizer (10,000 words/mo)',
      'Unlocked: Slides Agent & YouTube SEO',
      'Standard Support',
    ],
    icon: Zap,
  },
  {
    ...
    features: [
      'Unlimited InstantSites',
      'Unlimited SEO Audits',
      '100,000 AI Content words per month',
      '100 AI Image & 3 AI Video generations',
      'Unlocked: 1-Click CMS Auto-Publishing',
      'Unlocked: Data Analyzer & Rank Tracker',
  ...
  },
  {
    ...
    features: [
      'Infinite Limits (Fair Use Policy)',
      '500 AI Image & 15 AI Video generations',
