...
export default function AITutorPage() {
  ...
  // Helper: temporarily expand the canvas to its full content size for capture
  const prepareForCapture = (element: HTMLElement) => {
    const parent = element.parentElement
    const saved = {
      elOverflow: element.style.overflow,
      elHeight: element.style.height,
      elMaxHeight: element.style.maxHeight,
      elWidth: element.style.width,
      elMinWidth: element.style.minWidth,
  ...
  const restoreAfterCapture = (element: HTMLElement, saved: any) => {
    const parent = element.parentElement
    element.style.overflow = saved.elOverflow
    element.style.height = saved.elHeight
    element.style.maxHeight = saved.elMaxHeight
    element.style.width = saved.elWidth
    element.style.minWidth = saved.elMinWidth
    if (parent) {
