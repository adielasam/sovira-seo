  ...
  useEffect(() => {
    ...
    const loadIntegration = async () => {
      ...
      if (data) {
        ...
        if (data.auto_publish_topics) {
          if (Array.isArray(data.auto_publish_topics)) {
            setAutoPublishTopics(data.auto_publish_topics.join(', '))
          } else if (typeof data.auto_publish_topics === 'string') {
            setAutoPublishTopics(data.auto_publish_topics)
          }
        }
      }
      setIsLoading(false)
